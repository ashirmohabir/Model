...
class cicidspipeline:
    ...
    def cicids_process_data_binary(self):
        ...
        train_data_1 = read_file_lines('cicids',
                                           'Friday-WorkingHours-Afternoon-DDos.pcap_ISCX.csv')
        train_data_1.pop(0)
        shuffle(train_data_1)

        train_data_2 = read_file_lines('cicids',
                                           'Friday-WorkingHours-Afternoon-PortScan.pcap_ISCX.csv')
        train_data_2.pop(0)
        shuffle(train_data_2)

        train_data_3 = read_file_lines('cicids',
                                           'Friday-WorkingHours-Morning.pcap_ISCX.csv')
        train_data_3.pop(0)
        shuffle(train_data_3)

        train_data_5 = read_file_lines('cicids',
                                           'Thursday-WorkingHours-Afternoon-Infilteration.pcap_ISCX.csv')
        train_data_5.pop(0)
        shuffle(train_data_5)

        train_data_6 = read_file_lines('cicids',
                                           'Thursday-WorkingHours-Morning-WebAttacks.pcap_ISCX.csv')
        train_data_6.pop(0)
        shuffle(train_data_6)

        train_data_7 = read_file_lines('cicids',
                                           'Tuesday-WorkingHours.pcap_ISCX.csv')
        train_data_7.pop(0)
        shuffle(train_data_7)

        train_data_8 = read_file_lines('cicids',
